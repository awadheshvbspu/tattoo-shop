...
export default function Hero() {
  ...
  return (
    <section className='bg-hero bg-cover bg-center min-h-[40vh] lg:h-[948px] bg-no-repeat relative mt-[120px] lg:mt-[140px]'>
      <motion.div variants={container} initial='hidden' whileInView={'show'} className='container mx-auto  min-h-[40vh] lg:h-full flex items-center justify-center xl:justify-end'>
        <div className='text-white text-center lg:text-left lg:max-w-[649px]'>
          ...
          <motion.div variants={fadeIn('down')} className='btn btn-sm lg:btn-lg btn-outline mx-auto lg:mx-0 w-[240px]'>{btnText} <div className='text-xl'>{btnIcon}</div></motion.div>
        </div>
      </motion.div>
